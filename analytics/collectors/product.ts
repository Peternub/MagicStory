...
select
  ...
  (select count(*)::numeric / (select baseline_days from bounds) from public."user" u, bounds where u."createdAt" >= baseline_from and u."createdAt" < previous_from) new_baseline,
...
select
  ...
  count(*) filter (where occurred_at >= baseline_from and occurred_at < previous_from)::numeric / (select baseline_days from bounds) requests_baseline,
  ...
  count(*) filter (where status = 'succeeded' and occurred_at >= baseline_from and occurred_at < previous_from)::numeric / (select baseline_days from bounds) success_baseline,
  ...
  count(*) filter (where status = 'failed' and occurred_at >= baseline_from and occurred_at < previous_from)::numeric / (select baseline_days from bounds) failed_baseline,
